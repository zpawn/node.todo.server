...
// Create todo list
app.post('/todo/:listName', function (req, res) {
...
app.get('/todo/:listName', function (req, res) {
...
// Update
app.put('/todo/:listName', function (req, res) {
	if (!req.body.todo) {
		res.status(500);
		res.send({
			updated: false,
...
// Delete todo
app.delete('/todo/:listName', function (req, res) {
